      ...
      <View className="mt-20 flex-1 flex-col px-6 items-center">
        <View className="flex flex-row items-center gap-x-5 mb-8">
          ...
          <TouchableOpacity
            ...
            onPress={() => navigation.navigate(ROUTES.MY_ACCOUNT)}
          >
            <Text className="font-extrabold text-lg">My Account</Text>
        ...
        <View className="flex flex-row items-center gap-x-5">
          ...
          <TouchableOpacity
            className="flex-1 flex-row items-center justify-between"
            onPress={() => navigation.navigate(ROUTES.MY_GOALS)}
          >
            <Text className="font-extrabold text-lg">My Goals</Text>
            <Icon name="right" type="ant-design" color="#777" size={24} />
          </TouchableOpacity>
        </View>

        <TouchableOpacity
          className="py-3 bg-blue-brand rounded-full w-48 mt-56"
