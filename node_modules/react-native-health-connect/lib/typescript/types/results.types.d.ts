...
interface ActiveCaloriesBurnedRecordResult extends Replace<ActiveCaloriesBurnedRecord, 'energy', EnergyResult> {
}
interface BasalBodyTemperatureRecordResult extends Replace<BasalBodyTemperatureRecord, 'temperature', {
    inFahrenheit: number;
    inCelsius: number;
}> {
}
interface BasalMetabolicRateRecordResult extends Replace<BasalMetabolicRateRecord, 'basalMetabolicRate', {
    inKilocaloriesPerDay: number;
    inWatts: number;
}> {
}
interface BloodGlucoseRecordResult extends Replace<BloodGlucoseRecord, 'level', {
...
interface BodyWaterMassRecordResult extends Replace<BodyWaterMassRecord, 'mass', MassResult> {
}
interface BoneMassRecordResult extends Replace<BoneMassRecord, 'mass', MassResult> {
}
interface CervicalMucusRecordResult extends CervicalMucusRecord {
}
interface CyclingPedalingCadenceRecordResult extends CyclingPedalingCadenceRecord {
}
interface ElevationGainedRecordResult extends Omit<ElevationGainedRecord, 'elevation'> {
...
interface DistanceRecordResult extends Replace<DistanceRecord, 'distance', LengthResult> {
}
interface HeightRecordResult extends Replace<HeightRecord, 'height', LengthResult> {
}
interface HydrationRecordResult extends Replace<HydrationRecord, 'volume', VolumeResult> {
}
...
interface IntermenstrualBleedingRecordResult extends IntermenstrualBleedingRecord {
}
interface LeanBodyMassRecordResult extends Replace<LeanBodyMassRecord, 'mass', MassResult> {
}
interface SpeedRecordResult extends Replace<SpeedRecord, 'samples', SpeedSampleResult[]> {
}
