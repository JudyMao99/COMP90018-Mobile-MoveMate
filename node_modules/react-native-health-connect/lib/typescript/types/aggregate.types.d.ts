import type { EnergyResult, LengthResult, MassResult, PowerResult, PressureResult, TimeRangeFilter, VelocityResult, VolumeResult } from './base.types';
...
export type AggregateRecordResult = ActiveCaloriesBurnedAggregateResult | BasalMetabolicRateAggregateResult | BloodPressureAggregateResult | ExerciseSessionAggregateResult | FloorsClimbedAggregateResult | CyclingPedalingCadenceAggregateResult | HeartRateAggregateResult | RestingHeartRateAggregateResult | StepsAggregateResult | DistanceAggregateResult | HeightAggregateResult | HydrationAggregateResult | WeightAggregateResult | NutritionAggregateResult | SpeedAggregateResult | SleepSessionAggregateResult | WheelchairPushesAggregateResult | StepsCadenceAggregateResult | TotalCaloriesBurnedAggregateResult | PowerAggregateResult;
