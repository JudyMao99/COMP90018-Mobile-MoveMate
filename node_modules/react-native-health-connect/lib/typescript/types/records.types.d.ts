import type { Energy, InstantaneousRecord, IntervalRecord, BloodGlucose, Power, Pressure, Temperature, TimeRangeFilter, Mass, Length, CyclingPedalingCadenceSample, HeartRateSample, Volume, SpeedSample, StepsCadenceSample, PowerSample, ExerciseSegment, ExerciseLap, SleepStage, ExerciseRoute } from './base.types';
...
export type HealthConnectRecord = ActiveCaloriesBurnedRecord | BasalBodyTemperatureRecord | BasalMetabolicRateRecord | BloodGlucoseRecord | BloodPressureRecord | BodyFatRecord | BodyTemperatureRecord | BodyWaterMassRecord | BoneMassRecord | CervicalMucusRecord | CyclingPedalingCadenceRecord | ElevationGainedRecord | ExerciseSessionRecord | FloorsClimbedRecord | HeartRateRecord | RestingHeartRateRecord | StepsRecord | StepsCadenceRecord | DistanceRecord | HeightRecord | HydrationRecord | HeartRateVariabilityRmssdRecord | SexualActivityRecord | WeightRecord | LeanBodyMassRecord | IntermenstrualBleedingRecord | SpeedRecord | MenstruationFlowRecord | MenstruationPeriodRecord | SleepSessionRecord | RespiratoryRateRecord | WheelchairPushesRecord | Vo2MaxRecord | OvulationTestRecord | TotalCaloriesBurnedRecord | OxygenSaturationRecord | PowerRecord;
